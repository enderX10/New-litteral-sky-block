...
public class LSBClient implements ClientModInitializer {
    ...
    public static void renderActualSky(Minecraft mc, WorldRenderContext event) {
        ...
        // TO JEST KLUCZOWY FRAGMENT - PRZYWRACAMY ZACHOWANIE Z 1.19.2 DO 1.20.4
        // Chmury muszą wiedzieć pod jakim kątem na nie patrzymy względem świata.
        poseStack.pushPose();

        // Nie mnożymy poseStack przez samego siebie.
        // Po prostu przenosimy orientację do globalnego ModelView przed renderowaniem opartym na starych shaderach
        RenderSystem.applyModelViewMatrix();

        if (mc.options.cloudStatus().get() != CloudStatus.OFF) {
            // Zmiana z GetPositionTexColorShader (nowszego) na to, czego chmury oczekują
